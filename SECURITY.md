...
Adiutor infrastructure is intentionally separated across multiple repositories:

| Repository | Purpose |
|---|---|
| `adiutor-mac` | Private source code repository |
| `adiutor` | Public release distribution repository |
| `adiutor-updates` | Public Sparkle update feed and appcast delivery |
...
Adiutor releases are distributed using signed update mechanisms.
...
Users should only install updates from official Adiutor distribution channels.
...
Unauthorized redistribution, impersonation, tampering, malicious repackaging, or fraudulent distribution of Adiutor binaries or branding may result in takedown requests or further action where applicable.
